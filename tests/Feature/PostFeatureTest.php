...
class PostFeatureTest extends TestCase
{
    ...
    public function test_can_get_all_posts_for_authenticated_user()
    {
        ...
        $response->assertStatus(200)
                 ...
                 ->assertJsonFragment(['title' => $post1->title])
    ...
    {
        Post::factory()->create(['title' => 'Searchable Title', 'user_id' => $this->user->id]);
        Post::factory()->create(['title' => 'Other Title', 'user_id' => $this->user->id]);
